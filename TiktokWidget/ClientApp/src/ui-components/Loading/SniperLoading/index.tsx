...
import { DivSpinnerLoading } from "./SniperLoadingStyle";

interface ISniperLoading {
  color?: string;
}
export default function SniperLoading(props: ISniperLoading) {
  return (
    <DivSpinnerLoading className="orichi-loader" color={props.color}>
